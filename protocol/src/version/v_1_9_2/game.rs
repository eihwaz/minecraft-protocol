...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::ServerBoundUpdateSign(_) => 0x19,
...
impl ClientBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::Title(_) => 0x45,
            Self::ClientBoundUpdateSign(_) => 0x46,
            Self::SoundEffect(_) => 0x47,
            Self::PlayerlistHeader(_) => 0x48,
            Self::Collect(_) => 0x49,
            Self::EntityTeleport(_) => 0x4A,
            Self::EntityUpdateAttributes(_) => 0x4B,
            Self::EntityEffect(_) => 0x4C,
        }
    }
