...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::ServerBoundTabComplete(_) => 0x04,
...
impl ClientBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::CraftRecipeResponse(_) => 0x2C,
            Self::ClientBoundAbilities(_) => 0x2D,
            Self::CombatEvent(_) => 0x2E,
            Self::PlayerInfo(_) => 0x2F,
            Self::ClientBoundPosition(_) => 0x30,
            Self::Bed(_) => 0x31,
            Self::UnlockRecipes(_) => 0x32,
            Self::EntityDestroy => 0x33,
            Self::RemoveEntityEffect(_) => 0x34,
            Self::ResourcePackSend(_) => 0x35,
            Self::Respawn(_) => 0x36,
            Self::EntityHeadRotation(_) => 0x37,
            Self::WorldBorder(_) => 0x39,
            Self::Camera(_) => 0x3A,
            Self::ClientBoundHeldItemSlot(_) => 0x3B,
            Self::ScoreboardDisplayObjective(_) => 0x3C,
            Self::EntityMetadata(_) => 0x3D,
            Self::AttachEntity(_) => 0x3E,
            Self::EntityVelocity(_) => 0x3F,
            Self::EntityEquipment(_) => 0x40,
            Self::Experience(_) => 0x41,
            Self::UpdateHealth(_) => 0x42,
            Self::ScoreboardObjective(_) => 0x43,
            Self::SetPassengers(_) => 0x44,
            Self::Teams(_) => 0x45,
            Self::ScoreboardScore(_) => 0x46,
            Self::SpawnPosition(_) => 0x47,
            Self::UpdateTime(_) => 0x48,
            Self::Title(_) => 0x49,
            Self::StopSound(_) => 0x4A,
            Self::SoundEffect(_) => 0x4B,
            Self::PlayerlistHeader(_) => 0x4C,
            Self::Collect(_) => 0x4D,
            Self::EntityTeleport(_) => 0x4E,
            Self::EntityUpdateAttributes(_) => 0x50,
            Self::EntityEffect(_) => 0x51,
            Self::SelectAdvancementTab(_) => 0x38,
            Self::DeclareRecipes => 0x52,
            Self::Tags(_) => 0x53,
        }
    }
    ...
    pub fn tags(block_tags: TagsMap, item_tags: TagsMap) -> Self {
        let tags = Tags {
            block_tags,
            item_tags,
        };
