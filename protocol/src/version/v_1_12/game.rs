...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::ServerBoundPosition(_) => 0x0E,
            Self::PositionLook(_) => 0x0F,
            Self::Look(_) => 0x10,
            Self::Flying(_) => 0x0D,
...
impl ClientBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::Bed(_) => 0x2F,
            Self::UnlockRecipes(_) => 0x30,
            Self::EntityDestroy => 0x31,
            Self::RemoveEntityEffect(_) => 0x32,
            Self::ResourcePackSend(_) => 0x33,
            Self::Respawn(_) => 0x34,
            Self::EntityHeadRotation(_) => 0x35,
            ...
            Self::EntityUpdateAttributes(_) => 0x4D,
            Self::EntityEffect(_) => 0x4E,
            Self::SelectAdvancementTab(_) => 0x36,
        }
    }
