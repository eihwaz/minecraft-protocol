...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::NameItem(_) => 0x1F,
            Self::SelectTrade(_) => 0x22,
            Self::SetBeaconEffect(_) => 0x23,
            Self::UpdateCommandBlock(_) => 0x25,
            Self::UpdateCommandBlockMinecart(_) => 0x26,
            Self::UpdateStructureBlock(_) => 0x29,
            ...
            Self::CraftingBookData(_) => 0x1E,
            Self::ResourcePackReceive(_) => 0x20,
            Self::ServerBoundHeldItemSlot(_) => 0x24,
            Self::SetCreativeSlot(_) => 0x27,
            Self::UpdateJigsawBlock(_) => 0x28,
            Self::UpdateSign(_) => 0x2A,
            Self::ArmAnimation(_) => 0x2B,
            Self::Spectate(_) => 0x2C,
            Self::BlockPlace(_) => 0x2D,
            Self::UseItem(_) => 0x2E,
            Self::AdvancementTab(_) => 0x21,
        }
    }
