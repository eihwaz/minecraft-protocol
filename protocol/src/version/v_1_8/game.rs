...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            Self::ServerBoundKeepAlive(_) => 0x00,
            Self::ServerBoundChat(_) => 0x01,
            Self::UseEntity(_) => 0x02,
            Self::Flying(_) => 0x03,
            Self::ServerBoundPosition(_) => 0x04,
            Self::Look(_) => 0x05,
            Self::PositionLook(_) => 0x06,
            Self::BlockDig(_) => 0x07,
            Self::BlockPlace(_) => 0x08,
            Self::ServerBoundHeldItemSlot(_) => 0x09,
            Self::ArmAnimation => 0x0A,
            Self::EntityAction(_) => 0x0B,
            Self::SteerVehicle(_) => 0x0C,
            Self::ServerBoundCloseWindow(_) => 0x0D,
            Self::WindowClick(_) => 0x0E,
            Self::ServerBoundTransaction(_) => 0x0F,
            Self::SetCreativeSlot(_) => 0x10,
            Self::EnchantItem(_) => 0x11,
            Self::ServerBoundUpdateSign(_) => 0x12,
            Self::ServerBoundAbilities(_) => 0x13,
            Self::ServerBoundTabComplete(_) => 0x14,
            Self::Settings(_) => 0x15,
            Self::ClientCommand(_) => 0x16,
            Self::ServerBoundCustomPayload(_) => 0x17,
            Self::Spectate(_) => 0x18,
            Self::ResourcePackReceive(_) => 0x19,
        }
    }
    ...
    pub fn decode<R: Read>(type_id: u8, reader: &mut R) -> Result<Self, DecodeError> {
        match type_id {
            ...
            0x12 => {
                let server_bound_update_sign = ServerBoundUpdateSign::decode(reader)?;

                Ok(Self::ServerBoundUpdateSign(server_bound_update_sign))
            }
            0x13 => {
    ...
    pub fn server_bound_update_sign(
        location: Position,
        text1: String,
        text2: String,
        text3: String,
        ...
        let server_bound_update_sign = ServerBoundUpdateSign {
            location,
            text1,
            text2,
            text3,
        ...
        Self::ServerBoundUpdateSign(server_bound_update_sign)
    }
    ...
    pub fn server_bound_tab_complete(text: String, block: Position) -> Self {
        let server_bound_tab_complete = ServerBoundTabComplete { text, block };
    ...
    pub fn client_command(payload: i32) -> Self {
        let client_command = ClientCommand { payload };
    ...
    pub fn resource_pack_receive(hash: String, result: i32) -> Self {
        let resource_pack_receive = ResourcePackReceive { hash, result };
...
pub enum ClientBoundGamePacket {
    ...
    ClientBoundUpdateSign(ClientBoundUpdateSign),
    Map(Map),
...
impl ClientBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            Self::ClientBoundKeepAlive(_) => 0x00,
            Self::JoinGame(_) => 0x01,
            Self::ClientBoundChat(_) => 0x02,
            Self::UpdateTime(_) => 0x03,
            Self::EntityEquipment(_) => 0x04,
            Self::SpawnPosition(_) => 0x05,
            Self::UpdateHealth(_) => 0x06,
            Self::Respawn(_) => 0x07,
            Self::ClientBoundPosition(_) => 0x08,
            Self::ClientBoundHeldItemSlot(_) => 0x09,
            Self::Bed(_) => 0x0A,
            Self::Animation(_) => 0x0B,
            Self::NamedEntitySpawn(_) => 0x0C,
            Self::Collect(_) => 0x0D,
            Self::SpawnEntity(_) => 0x0E,
            Self::SpawnEntityLiving(_) => 0x0F,
            Self::SpawnEntityPainting(_) => 0x10,
            Self::SpawnEntityExperienceOrb(_) => 0x11,
            Self::EntityVelocity(_) => 0x12,
            Self::EntityDestroy => 0x13,
            Self::Entity(_) => 0x14,
            Self::RelEntityMove(_) => 0x15,
            Self::EntityLook(_) => 0x16,
            Self::EntityMoveLook(_) => 0x17,
            Self::EntityTeleport(_) => 0x18,
            Self::EntityHeadRotation(_) => 0x19,
            Self::EntityStatus(_) => 0x1A,
            Self::AttachEntity(_) => 0x1B,
            Self::EntityMetadata(_) => 0x1C,
            Self::EntityEffect(_) => 0x1D,
            Self::RemoveEntityEffect(_) => 0x1E,
            Self::Experience(_) => 0x1F,
            Self::UpdateAttributes(_) => 0x20,
            Self::MapChunk(_) => 0x21,
            Self::MultiBlockChange(_) => 0x22,
            Self::BlockChange(_) => 0x23,
            Self::BlockAction(_) => 0x24,
            Self::BlockBreakAnimation(_) => 0x25,
            Self::MapChunkBulk(_) => 0x26,
            Self::Explosion(_) => 0x27,
            Self::WorldEvent(_) => 0x28,
            Self::NamedSoundEffect(_) => 0x29,
            Self::WorldParticles(_) => 0x2A,
            Self::GameStateChange(_) => 0x2B,
            Self::SpawnEntityWeather(_) => 0x2C,
            Self::OpenWindow(_) => 0x2D,
            Self::ClientBoundCloseWindow(_) => 0x2E,
            Self::SetSlot(_) => 0x2F,
            Self::WindowItems(_) => 0x30,
            Self::CraftProgressBar(_) => 0x31,
            Self::ClientBoundTransaction(_) => 0x32,
            Self::ClientBoundUpdateSign(_) => 0x33,
            Self::Map(_) => 0x34,
            Self::TileEntityData(_) => 0x35,
            Self::OpenSignEntity(_) => 0x36,
            Self::Statistics => 0x37,
            Self::PlayerInfo(_) => 0x38,
            Self::ClientBoundAbilities(_) => 0x39,
            Self::ClientBoundTabComplete => 0x3A,
            Self::ScoreboardObjective(_) => 0x3B,
            Self::ScoreboardScore(_) => 0x3C,
            Self::ScoreboardDisplayObjective(_) => 0x3D,
            Self::ScoreboardTeam(_) => 0x3E,
            Self::ClientBoundCustomPayload(_) => 0x3F,
            Self::KickDisconnect(_) => 0x40,
            Self::Difficulty(_) => 0x41,
            Self::CombatEvent(_) => 0x42,
            Self::Camera(_) => 0x43,
            Self::WorldBorder(_) => 0x44,
            Self::Title(_) => 0x45,
            Self::SetCompression(_) => 0x46,
            Self::PlayerlistHeader(_) => 0x47,
            Self::ResourcePackSend(_) => 0x48,
            Self::UpdateEntityNbt(_) => 0x49,
        }
    }
    ...
    pub fn decode<R: Read>(type_id: u8, reader: &mut R) -> Result<Self, DecodeError> {
        match type_id {
            ...
            0x20 => {
                let update_attributes = UpdateAttributes::decode(reader)?;

                Ok(Self::UpdateAttributes(update_attributes))
            }
            0x21 => {
            ...
            0x26 => {
                let map_chunk_bulk = MapChunkBulk::decode(reader)?;
            ...
            0x33 => {
                let client_bound_update_sign = ClientBoundUpdateSign::decode(reader)?;

                Ok(Self::ClientBoundUpdateSign(client_bound_update_sign))
            }
            0x34 => {
            ...
            0x3A => Ok(Self::ClientBoundTabComplete),
            0x3B => {
            ...
            0x3E => {
                let scoreboard_team = ScoreboardTeam::decode(reader)?;

                Ok(Self::ScoreboardTeam(scoreboard_team))
            }
            0x3F => {
            ...
            0x46 => {
                ...
                Ok(Self::SetCompression(set_compression))
            }
            0x47 => {
            ...
            0x49 => {
                let update_entity_nbt = UpdateEntityNbt::decode(reader)?;

                Ok(Self::UpdateEntityNbt(update_entity_nbt))
            }
            _ => Err(DecodeError::UnknownPacketType { type_id }),
        }
    }
    ...
    pub fn entity_equipment(entity_id: i32, slot: i16, item: Option<Slot>) -> Self {
    ...
    pub fn client_bound_position(x: f64, y: f64, z: f64, yaw: f32, pitch: f32, flags: i8) -> Self {
    ...
    pub fn collect(collected_entity_id: i32, collector_entity_id: i32) -> Self {
        let collect = Collect {
            collected_entity_id,
            collector_entity_id,
        };
    ...
    pub fn spawn_entity_experience_orb(entity_id: i32, x: i32, y: i32, z: i32, count: i16) -> Self {
    ...
    pub fn rel_entity_move(entity_id: i32, d_x: i8, d_y: i8, d_z: i8, on_ground: bool) -> Self {
    ...
    pub fn attach_entity(entity_id: i32, vehicle_id: i32, leash: bool) -> Self {
    ...
    pub fn update_attributes(entity_id: i32) -> Self {
        let update_attributes = UpdateAttributes { entity_id };

        Self::UpdateAttributes(update_attributes)
    }

    pub fn map_chunk(x: i32, z: i32, ground_up: bool, bit_map: u16, chunk_data: Vec<u8>) -> Self {
    ...
    pub fn map_chunk_bulk(sky_light_sent: bool, data: Vec<u8>) -> Self {
        let map_chunk_bulk = MapChunkBulk {
            sky_light_sent,
            data,
        };

        Self::MapChunkBulk(map_chunk_bulk)
    }
    ...
    pub fn spawn_entity_weather(entity_id: i32, type_: i8, x: i32, y: i32, z: i32) -> Self {
    ...
    pub fn client_bound_update_sign(
        location: Position,
        text1: String,
        text2: String,
        text3: String,
        ...
        let client_bound_update_sign = ClientBoundUpdateSign {
            location,
            text1,
            text2,
            text3,
        ...
        Self::ClientBoundUpdateSign(client_bound_update_sign)
    }

    pub fn map(item_damage: i32, scale: i8, columns: i8) -> Self {
        let map = Map {
            item_damage,
            scale,
            columns,
    ...
    pub fn scoreboard_team(team: String, mode: i8) -> Self {
        let scoreboard_team = ScoreboardTeam { team, mode };

        Self::ScoreboardTeam(scoreboard_team)
    }
    ...
    pub fn set_compression(threshold: i32) -> Self {
    ...
    pub fn update_entity_nbt(entity_id: i32, tag: CompoundTag) -> Self {
        let update_entity_nbt = UpdateEntityNbt { entity_id, tag };

        Self::UpdateEntityNbt(update_entity_nbt)
    }
}
...
#[derive(Packet, Debug)]
pub struct ClientBoundUpdateSign {
    pub location: Position,
    pub text1: String,
    pub text2: String,
    pub text3: String,
