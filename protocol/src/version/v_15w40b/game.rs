...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            Self::ServerBoundKeepAlive(_) => 0x0A,
            Self::ServerBoundChat(_) => 0x01,
            Self::UseEntity(_) => 0x09,
            Self::Flying(_) => 0x0E,
            Self::ServerBoundPosition(_) => 0x0B,
            Self::Look(_) => 0x0D,
            Self::PositionLook(_) => 0x0C,
            Self::BlockDig(_) => 0x10,
            Self::BlockPlace(_) => 0x19,
            Self::ServerBoundHeldItemSlot(_) => 0x14,
            Self::ArmAnimation(_) => 0x17,
            Self::EntityAction(_) => 0x11,
            Self::SteerVehicle(_) => 0x12,
            Self::ServerBoundCloseWindow(_) => 0x07,
            Self::WindowClick(_) => 0x06,
            Self::ServerBoundTransaction(_) => 0x04,
            Self::SetCreativeSlot(_) => 0x15,
            Self::EnchantItem(_) => 0x05,
            Self::ServerBoundUpdateSign(_) => 0x16,
            Self::ServerBoundAbilities(_) => 0x0F,
            Self::ServerBoundTabComplete(_) => 0x00,
            Self::Settings(_) => 0x03,
            Self::ClientCommand(_) => 0x02,
            Self::ServerBoundCustomPayload(_) => 0x08,
            Self::Spectate(_) => 0x18,
            Self::ResourcePackReceive(_) => 0x13,
            Self::UseItem(_) => 0x1A,
        }
    }
...
impl ClientBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::ClientBoundUpdateSign(_) => 0x45,
            Self::Map(_) => 0x25,
            ...
            Self::ScoreboardScore(_) => 0x41,
            Self::ScoreboardDisplayObjective(_) => 0x38,
            Self::ScoreboardTeam(_) => 0x40,
            ...
            Self::Title(_) => 0x44,
            Self::SetCompression(_) => 0x1D,
            Self::PlayerlistHeader(_) => 0x46,
