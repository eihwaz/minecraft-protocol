...
impl ServerBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::PrepareCraftingGrid(_) => 0x01,
            Self::ServerBoundTabComplete(_) => 0x02,
            ...
            Self::UseEntity(_) => 0x0B,
            Self::ServerBoundKeepAlive(_) => 0x0C,
            Self::ServerBoundPosition(_) => 0x0D,
            Self::PositionLook(_) => 0x0E,
            Self::Look(_) => 0x0F,
            Self::Flying(_) => 0x10,
            Self::ServerBoundVehicleMove(_) => 0x11,
            Self::SteerBoat(_) => 0x12,
            ...
            Self::ServerBoundHeldItemSlot(_) => 0x19,
            Self::SetCreativeSlot(_) => 0x1A,
            Self::UpdateSign(_) => 0x1B,
            Self::ArmAnimation(_) => 0x1C,
            Self::Spectate(_) => 0x1D,
            Self::BlockPlace(_) => 0x1E,
            Self::UseItem(_) => 0x1F,
    ...
    pub fn decode<R: Read>(type_id: u8, reader: &mut R) -> Result<Self, DecodeError> {
        match type_id {
            ...
            0x01 => {
                let prepare_crafting_grid = PrepareCraftingGrid::decode(reader)?;

                Ok(Self::PrepareCraftingGrid(prepare_crafting_grid))
            }
            0x02 => {
    ...
    pub fn prepare_crafting_grid(window_id: u8, action_number: u16) -> Self {
        let prepare_crafting_grid = PrepareCraftingGrid {
            window_id,
            action_number,
        };

        Self::PrepareCraftingGrid(prepare_crafting_grid)
    }
    ...
    pub fn crafting_book_data(type_: u32) -> Self {
...
impl ClientBoundGamePacket {
    pub fn get_type_id(&self) -> u8 {
        match self {
            ...
            Self::Advancements(_) => 0x08,
            Self::BlockBreakAnimation(_) => 0x09,
            Self::TileEntityData(_) => 0x0A,
            Self::BlockAction(_) => 0x0B,
            Self::BlockChange(_) => 0x0C,
            Self::BossBar(_) => 0x0D,
            Self::Difficulty(_) => 0x0E,
            Self::ClientBoundTabComplete => 0x0F,
            Self::ClientBoundChat(_) => 0x10,
            Self::MultiBlockChange(_) => 0x11,
            ...
            Self::Explosion(_) => 0x1D,
            Self::UnloadChunk(_) => 0x1E,
            Self::GameStateChange(_) => 0x1F,
            ...
            Self::Entity(_) => 0x29,
            Self::ClientBoundVehicleMove(_) => 0x2A,
            Self::OpenSignEntity(_) => 0x2B,
            ...
            Self::WorldBorder(_) => 0x37,
            Self::Camera(_) => 0x38,
            Self::ClientBoundHeldItemSlot(_) => 0x39,
            Self::ScoreboardDisplayObjective(_) => 0x3A,
            Self::EntityMetadata(_) => 0x3B,
            Self::AttachEntity(_) => 0x3C,
            Self::EntityVelocity(_) => 0x3D,
            Self::EntityEquipment(_) => 0x3E,
            Self::Experience(_) => 0x3F,
            Self::UpdateHealth(_) => 0x40,
            Self::ScoreboardObjective(_) => 0x41,
            Self::SetPassengers(_) => 0x42,
            Self::Teams(_) => 0x43,
            Self::ScoreboardScore(_) => 0x44,
            Self::SpawnPosition(_) => 0x45,
            Self::UpdateTime(_) => 0x46,
            Self::Title(_) => 0x47,
            Self::SoundEffect(_) => 0x48,
            Self::PlayerlistHeader(_) => 0x49,
            Self::Collect(_) => 0x4A,
            Self::EntityTeleport(_) => 0x4B,
            Self::EntityUpdateAttributes(_) => 0x4C,
            Self::EntityEffect(_) => 0x4D,
            Self::AdvancementProgress(_) => 0x4E,
        }
    }
    ...
    pub fn decode<R: Read>(type_id: u8, reader: &mut R) -> Result<Self, DecodeError> {
        match type_id {
            ...
            0x0F => Ok(Self::ClientBoundTabComplete),
            0x10 => {
            ...
            0x4E => {
                let advancement_progress = AdvancementProgress::decode(reader)?;

                Ok(Self::AdvancementProgress(advancement_progress))
            }
            _ => Err(DecodeError::UnknownPacketType { type_id }),
        }
    }
    ...
    pub fn advancement_progress(id: String) -> Self {
        let advancement_progress = AdvancementProgress { id };

        Self::AdvancementProgress(advancement_progress)
    }
}
